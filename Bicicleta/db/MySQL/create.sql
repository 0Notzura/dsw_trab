...
LOCADORA_ID BIGINT PRIMARY KEY auto_increment,
EMAIL VARCHAR(100) UNIQUE NOT NULL,
...
FOREIGN KEY (LOCADORA_ID) REFERENCES LOCADORA(LOCADORA_ID)
);
...
insert into CLIENTE(EMAIL,TELEFONE,SENHA,SEXO,CPF,NASCIMENTO) values ('abc@123.com.bc','19999776600','M','admin',4322347579,12/03/2001)
